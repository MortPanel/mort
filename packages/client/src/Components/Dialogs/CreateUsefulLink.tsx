...
import { createUsefulLink } from "@/utils/apiRequests";
import type { APIError } from "@/Types/APIError";

export default function CreateUsefulLinkDialog({
    children,
}: {
    ...
    const click = async () => {
        const create = await createUsefulLink(
            formData.title,
            formData.url,
